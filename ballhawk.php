...
<main class='work-page'>
  <section class='work-intro'>
    <div class='container'>
      <div class='row work-section'>
        <div class='col-sm-12'>
          <img src='images/ballhawk/work-ballhawk-intro.jpg' class='img-responsive'>
        </div>
      </div>
  ...
  <section class='work'>
    <div class='container'>
      <h3 class='work-subtitle'>Branding Ballhawk</h3>
      <div class='row work-section padding-bottom-40px'>
        <div class='col-sm-6'>
          <img src='images/ballhawk/work-ballhawk-brand-logo.jpg' class='img-responsive'>
        </div>
        <div class='col-sm-6'>
          <img src='images/ballhawk/work-ballhawk-brand-logo-dark.jpg' class='img-responsive'>
        </div>
      ...
      <div class='row work-section padding-bottom-40px'>
        <div class='col-sm-6'>
          <img src='images/ballhawk/work-ballhawk-brand-1.jpg' class='img-responsive'>
        </div>
        <div class='col-sm-6'>
          <img src='images/ballhawk/work-ballhawk-brand-2.jpg' class='img-responsive'>
        </div>
        <div class='col-md-12 padding-top-10px'>
      ...
      <div class='row work-section padding-bottom-30px'>
        <div class='col-sm-3'>
          <img src='images/ballhawk/work-ballhawk-app-icons.jpg' class='img-responsive'>
        </div>
        <div class='col-sm-3'>
          <img src='images/ballhawk/work-ballhawk-app-iphone.jpg' class='img-responsive'>
        </div>
        <div class='col-sm-3'>
          <img src='images/ballhawk/work-ballhawk-itunes-store.jpg' class='img-responsive'>
        </div>
        <div class='col-sm-3'>
          <img src='images/ballhawk/work-ballhawk-sticker.jpg' class='img-responsive'>
        </div>
         <div class='col-md-12 padding-top-10px'>
      ...
      <div class='row work-section padding-bottom-30px'>
        <div class='col-sm-6'>
          <img src='images/ballhawk/work-ballhawk-illo-closeup.jpg' class='img-responsive'>
        </div>
        <div class='col-sm-6'>
          <img src='images/ballhawk/work-ballhawk-illo-iphone.jpg' class='img-responsive'>
        </div>
      </div>
      <div class='row work-section padding-bottom-40px'>
        <div class='col-md-8 col-md-offset-2 padding-top-30px padding-bottom-60px'>
